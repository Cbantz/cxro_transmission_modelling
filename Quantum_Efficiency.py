...
def QE_Interpolated_Function(min : int, max : int, Si_thickness : float, C_thickness : float, SiO2_thickness : float, Fe_thickness : float, step : int = 100):
...
if __name__ == "__main__":
    func = QE_Interpolated_Function(30, 2000, 5, 0.1, 0.1, 0.05, 100)
    test_range = range(30, 2000, 50)
    plt.plot(test_range, func(test_range))
    plt.show()
